...
var profiles;
var profile_group_index = 0;

var profile_group_edit_temp;
var profile_group_remove_temp;
var profile_index;



let xhr_profiles = new XMLHttpRequest();
...
window.addEventListener("load", function(){
    ...
    document.getElementById("menu_search").addEventListener("keyup",
        function(event) {
            if (document.getElementById("profiles_page").style.visibility === 'visible') { 
                var search_term = document.getElementById("menu_search").value.toLowerCase()
                if(search_term == "") {
                    update_profiles_table()
                } else {
                    update_profiles_table_by_search(search_term)
                }
    ...
    document.getElementById("profiles_export_search").addEventListener("keyup",
        function(event) {
            var search_term = document.getElementById("profiles_export_search").value.toLowerCase()
            var table = document.getElementById("export_option-table_main")
...
// PROFILES
function show_popup_profile_add() {
    document.getElementById("add-shipping-name").disabled = false;
    document.getElementById("add-shipping-name").setAttribute("style","background:#161A2D;")

    document.getElementById("add-card_name").disabled = false;
    document.getElementById("add-card_name").setAttribute("style","background:#161A2D;");
    
    document.getElementById("add-shipping-email").disabled = false;
    document.getElementById("add-shipping-email").setAttribute("style","background:#161A2D;")
    document.getElementById("add-shipping-phone").disabled = false;
    document.getElementById("add-shipping-phone").setAttribute("style","background:#161A2D;")
    document.getElementById("add-shipping-address1").disabled = false;
    document.getElementById("add-shipping-address1").setAttribute("style","background:#161A2D;")
    document.getElementById("add-shipping-address2").disabled = false;
    document.getElementById("add-shipping-address2").setAttribute("style","background:#161A2D;")
    document.getElementById("add-shipping-zip").disabled = false;
    document.getElementById("add-shipping-zip").setAttribute("style","background:#161A2D;")
    document.getElementById("add-shipping-city").disabled = false;
    document.getElementById("add-shipping-city").setAttribute("style","background:#161A2D;")
    document.getElementById("add-shipping-country").disabled = false;
    document.getElementById("add-shipping-country").setAttribute("style","background:#161A2D;")
    document.getElementById("add-shipping-state").disabled = false;
    document.getElementById("add-shipping-state").setAttribute("style","background:#161A2D;")
    var popup = document.getElementById("popup-profile_add");

    let checkbox_add_same_shipping = document.getElementById("add-same_shipping");
    let checkbox_add_same_names = document.getElementById("add-same_names");

    checkbox_add_same_shipping.addEventListener("click", function() {
        if(checkbox_add_same_shipping.checked == 1) {
            document.getElementById("add-shipping-name").disabled = true;
            document.getElementById("add-shipping-name").setAttribute("style","background:#0d101c;")
            document.getElementById("add-shipping-email").disabled = true;
            document.getElementById("add-shipping-email").setAttribute("style","background:#0d101c;")
            document.getElementById("add-shipping-phone").disabled = true;
            document.getElementById("add-shipping-phone").setAttribute("style","background:#0d101c;")
            document.getElementById("add-shipping-address1").disabled = true;
            document.getElementById("add-shipping-address1").setAttribute("style","background:#0d101c;")
            document.getElementById("add-shipping-address2").disabled = true;
            document.getElementById("add-shipping-address2").setAttribute("style","background:#0d101c;")
            document.getElementById("add-shipping-zip").disabled = true;
            document.getElementById("add-shipping-zip").setAttribute("style","background:#0d101c;")
            document.getElementById("add-shipping-city").disabled = true;
            document.getElementById("add-shipping-city").setAttribute("style","background:#0d101c;")
            document.getElementById("add-shipping-country").disabled = true;
            document.getElementById("add-shipping-country").setAttribute("style","background:#0d101c;")
            document.getElementById("add-shipping-state").disabled = true;
            document.getElementById("add-shipping-state").setAttribute("style","background:#0d101c;")
        } else {
            if (checkbox_add_same_names.checked == 0) {
                document.getElementById("add-shipping-name").disabled = false;
                document.getElementById("add-shipping-name").setAttribute("style","background:#161A2D;")
            }
    ...
    checkbox_add_same_names.addEventListener("click", function() {
        if (checkbox_add_same_names.checked == 1) {
            document.getElementById("add-card_name").disabled = true;
            document.getElementById("add-card_name").setAttribute("style","background:#0d101c;");
            document.getElementById("add-shipping-name").disabled = true;
            document.getElementById("add-shipping-name").setAttribute("style","background:#0d101c;")
        } else {
            document.getElementById("add-card_name").disabled = false;
            document.getElementById("add-card_name").setAttribute("style","background:#161A2D;");
            if(checkbox_add_same_shipping.checked == 0) {
                document.getElementById("add-shipping-name").disabled = false;
                document.getElementById("add-shipping-name").setAttribute("style","background:#161A2D;")
            }
        }
...
function hide_popup_profile_add() {
    document.getElementById("page_blocker").style.zIndex = 0;
    document.getElementById("page_blocker").style.display = "none";
    var popup = document.getElementById("popup-profile_add");
    document.getElementById("blur_section").setAttribute("style","filter: blur(0px);")
...
function show_popup_profile_edit() {
    var profile = profiles["groups"][profile_group_index]["profiles"][profile_index]

    document.getElementById("edit-profile-name").value = profile["profile_name"]

    document.getElementById("edit-billing-name").value = profile["billing"]["name"]
    document.getElementById("edit-billing-email").value = profile["billing"]["email"]
    document.getElementById("edit-billing-phone").value = profile["billing"]["phone"]
    document.getElementById("edit-billing-address1").value = profile["billing"]["line1"]
    document.getElementById("edit-billing-address2").value = profile["billing"]["line2"]
    document.getElementById("edit-billing-zip").value = profile["billing"]["post_code"]
    document.getElementById("edit-billing-city").value = profile["billing"]["city"]
    document.getElementById("edit-billing-country").value = profile["billing"]["country"]
    add_states("edit-billing-country","edit-billing-state")
    document.getElementById("edit-billing-state").value = profile["billing"]["state"]

    document.getElementById("edit-shipping-name").value = profile["shipping"]["name"]
    document.getElementById("edit-shipping-email").value = profile["shipping"]["email"]
    document.getElementById("edit-shipping-phone").value = profile["shipping"]["phone"]
    document.getElementById("edit-shipping-address1").value = profile["shipping"]["line1"]
    document.getElementById("edit-shipping-address2").value = profile["shipping"]["line2"]
    document.getElementById("edit-shipping-zip").value = profile["shipping"]["post_code"]
    document.getElementById("edit-shipping-city").value = profile["shipping"]["city"]
    document.getElementById("edit-shipping-country").value = profile["shipping"]["country"]
    add_states("edit-shipping-country","edit-shipping-state")
    document.getElementById("edit-shipping-state").value = profile["shipping"]["state"]

    document.getElementById("edit-card_type").value = profile["card"]["type"]
    document.getElementById("edit-card_name").value = profile["card"]["name"]
    document.getElementById("edit-card_number").value = profile["card"]["no"]
    document.getElementById("edit-card_exp_mo").value = profile["card"]["mo"]
    document.getElementById("edit-card_exp_yr").value = profile["card"]["yr"]
    document.getElementById("edit-card_cvv").value = profile["card"]["cvv"]

    if(profile["options"]["same_billing_shipping"]) {
        document.getElementById("edit-same_shipping").checked = true;

        document.getElementById("edit-shipping-name").disabled = true;
        document.getElementById("edit-shipping-name").setAttribute("style","background:#0d101c;")
        document.getElementById("edit-shipping-email").disabled = true;
        document.getElementById("edit-shipping-email").setAttribute("style","background:#0d101c;")
        document.getElementById("edit-shipping-phone").disabled = true;
        document.getElementById("edit-shipping-phone").setAttribute("style","background:#0d101c;")
        document.getElementById("edit-shipping-address1").disabled = true;
        document.getElementById("edit-shipping-address1").setAttribute("style","background:#0d101c;")
        document.getElementById("edit-shipping-address2").disabled = true;
        document.getElementById("edit-shipping-address2").setAttribute("style","background:#0d101c;")
        document.getElementById("edit-shipping-zip").disabled = true;
        document.getElementById("edit-shipping-zip").setAttribute("style","background:#0d101c;")
        document.getElementById("edit-shipping-city").disabled = true;
        document.getElementById("edit-shipping-city").setAttribute("style","background:#0d101c;")
        document.getElementById("edit-shipping-country").disabled = true;
        document.getElementById("edit-shipping-country").setAttribute("style","background:#0d101c;")
        document.getElementById("edit-shipping-state").disabled = true;
        document.getElementById("edit-shipping-state").setAttribute("style","background:#0d101c;")
    } else {
        document.getElementById("edit-same_shipping").checked = false;

        document.getElementById("edit-shipping-email").disabled = false;
        document.getElementById("edit-shipping-email").setAttribute("style","background:#161A2D;")
        document.getElementById("edit-shipping-phone").disabled = false;
        document.getElementById("edit-shipping-phone").setAttribute("style","background:#161A2D;")
        document.getElementById("edit-shipping-address1").disabled = false;
        document.getElementById("edit-shipping-address1").setAttribute("style","background:#161A2D;")
        document.getElementById("edit-shipping-address2").disabled = false;
        document.getElementById("edit-shipping-address2").setAttribute("style","background:#161A2D;")
        document.getElementById("edit-shipping-zip").disabled = false;
        document.getElementById("edit-shipping-zip").setAttribute("style","background:#161A2D;")
        document.getElementById("edit-shipping-city").disabled = false;
        document.getElementById("edit-shipping-city").setAttribute("style","background:#161A2D;")
        document.getElementById("edit-shipping-country").disabled = false;
        document.getElementById("edit-shipping-country").setAttribute("style","background:#161A2D;")
        document.getElementById("edit-shipping-state").disabled = false;
        document.getElementById("edit-shipping-state").setAttribute("style","background:#161A2D;")
    }

    if(profile["options"]["same_names"]){
        document.getElementById("edit-same_names").checked = true;

        document.getElementById("edit-card_name").disabled = true;
        document.getElementById("edit-card_name").setAttribute("style","background:#0d101c;");
    } else {
        document.getElementById("edit-same_names").checked = false;

        document.getElementById("edit-card_name").disabled = false;
        document.getElementById("edit-card_name").setAttribute("style","background:#161A2D;")
    }

    if(profile["options"]["checkout_once"]) {
        document.getElementById("edit-checkout_once").checked = true;
    } else {
        document.getElementById("edit-checkout_once").checked = false;
    }

    let checkbox_add_same_shipping = document.getElementById("edit-same_shipping");
    let checkbox_add_same_names = document.getElementById("edit-same_names");
    ...
    checkbox_add_same_shipping.addEventListener("click", function() {
        if(checkbox_add_same_shipping.checked == 1) {
            ...
            if (checkbox_add_same_names.checked == 0) {
                document.getElementById("edit-shipping-name").disabled = false;
                document.getElementById("edit-shipping-name").setAttribute("style","background:#161A2D;")
            }
    ...
    var popup = document.getElementById("popup-profile_edit")
    if(popup.style.visibility === "hidden") {
        document.getElementById("page_blocker").style.zIndex = 6000;
        document.getElementById("page_blocker").style.display = "inline";
        document.getElementById("blur_section").setAttribute("style","filter: blur(2px);")
...
function hide_popup_profile_edit() {
    document.getElementById("page_blocker").style.zIndex = 0;
    document.getElementById("page_blocker").style.display = "none";
    var popup = document.getElementById("popup-profile_edit");
    document.getElementById("blur_section").setAttribute("style","filter: blur(0px);")
...
function show_popup_profile_remove() {
    var checked = get_checked_in_profiles_table()
    ...
    var popup = document.getElementById("popup-profile_remove");
    if(popup.style.visibility === "hidden") {
        document.getElementById("page_blocker").style.zIndex = 6000;
        document.getElementById("page_blocker").style.display = "inline";
        document.getElementById("blur_section").setAttribute("style","filter: blur(2px);")
...
function hide_popup_profile_remove() {
    document.getElementById("page_blocker").style.zIndex = 0;
    document.getElementById("page_blocker").style.display = "none";
    var popup = document.getElementById("popup-profile_remove");
    document.getElementById("blur_section").setAttribute("style","filter: blur(0px);")
...
function show_popup_profile_import() {
    var popup = document.getElementById("popup-profile_import");
    if(popup.style.visibility === "hidden") {
        document.getElementById("page_blocker").style.zIndex = 6000;
        document.getElementById("page_blocker").style.display = "inline";
        document.getElementById("blur_section").setAttribute("style","filter: blur(2px);")
...
function hide_popup_profile_import() {
    document.getElementById("page_blocker").style.zIndex = 0;
    document.getElementById("page_blocker").style.display = "none";
    var popup = document.getElementById("popup-profile_import");
    document.getElementById("blur_section").setAttribute("style","filter: blur(0px);")
...
function show_popup_profile_import_error() {
    var popup = document.getElementById("popup-profile_import_error");
    if(popup.style.visibility === "hidden") {
        document.getElementById("page_blocker").style.zIndex = 6000;
        document.getElementById("page_blocker").style.display = "inline";
        document.getElementById("blur_section").setAttribute("style","filter: blur(2px);")
...
function hide_popup_profile_import_error() {
    document.getElementById("page_blocker").style.zIndex = 0;
    document.getElementById("page_blocker").style.display = "none";
    var popup = document.getElementById("popup-profile_import_error");
    document.getElementById("blur_section").setAttribute("style","filter: blur(0px);")
...
function show_popup_profile_export() {

    var table = document.getElementById("profiles-main_table");
    for(let i = 0; i < table.rows.length; i++) {
        table.rows[i].cells[4].getElementsByTagName('input')[0].checked = false;
    }

    var popup = document.getElementById("popup-profile_export");
    if(popup.style.visibility === "hidden") {
        document.getElementById("page_blocker").style.zIndex = 6000;
        document.getElementById("page_blocker").style.display = "inline";
        document.getElementById("blur_section").setAttribute("style","filter: blur(2px);")
...
function hide_popup_profile_export() {
    document.getElementById("page_blocker").style.zIndex = 0;
    document.getElementById("page_blocker").style.display = "none";
    var popup = document.getElementById("popup-profile_export");
    document.getElementById("blur_section").setAttribute("style","filter: blur(0px);")
...
function show_popup_profile_jig() {
    ...
    if (profiles["groups"].length != 6){
        var popup = document.getElementById("popup-profile_jig");
        toggle_name_jig()
        toggle_address_jig()
        toggle_email_jig()
        if(popup.style.visibility === "hidden") {
        ...
        show_popup_profile_jig_error()
    }

    
};
function hide_popup_profile_jig() {
    document.getElementById("page_blocker").style.zIndex = 0;
    document.getElementById("page_blocker").style.display = "none";
    var popup = document.getElementById("popup-profile_jig");
    document.getElementById("blur_section").setAttribute("style","filter: blur(0px);")
...
function show_popup_profile_jig_error() {

    var popup = document.getElementById("popup-profile_jig_error");
    if(popup.style.visibility === "hidden") {
        document.getElementById("page_blocker").style.zIndex = 6000;
        document.getElementById("page_blocker").style.display = "inline";
        document.getElementById("blur_section").setAttribute("style","filter: blur(2px);")
...
function hide_popup_profile_jig_error() {
    document.getElementById("page_blocker").style.zIndex = 0;
    document.getElementById("page_blocker").style.display = "none";
    var popup = document.getElementById("popup-profile_jig_error");
    document.getElementById("blur_section").setAttribute("style","filter: blur(0px);")
...
function show_popup_profile_export_error() {
    var popup = document.getElementById("popup-profile_export_error");
    if(popup.style.visibility === "hidden") {
        document.getElementById("page_blocker").style.zIndex = 6000;
        document.getElementById("page_blocker").style.display = "inline";
        document.getElementById("blur_section").setAttribute("style","filter: blur(2px);")
...
function hide_popup_profile_export_error() {
    document.getElementById("page_blocker").style.zIndex = 0;
    document.getElementById("page_blocker").style.display = "none";
    var popup = document.getElementById("popup-profile_export_error");
    document.getElementById("blur_section").setAttribute("style","filter: blur(0px);")
...
function show_popup_profile_export_success() {
    var popup = document.getElementById("popup-profile_export_success");
    if(popup.style.visibility === "hidden") {
        document.getElementById("page_blocker").style.zIndex = 6000;
        document.getElementById("page_blocker").style.display = "inline";
        document.getElementById("blur_section").setAttribute("style","filter: blur(2px);")
...
function hide_popup_profile_export_success() {
    document.getElementById("page_blocker").style.zIndex = 0;
    document.getElementById("page_blocker").style.display = "none";
    var popup = document.getElementById("popup-profile_export_success");
    document.getElementById("blur_section").setAttribute("style","filter: blur(0px);")
...
function show_popup_profile_move() {
    var profile_group_select = document.getElementById("profile_move-select")
    ...
    while(profile_group_select.hasChildNodes())
    {
        profile_group_select.removeChild(profile_group_select.firstChild);
    }

    for(var i in profiles["groups"]) {
        profile_group_select.options[profile_group_select.length] = new Option(profiles["groups"][i]["name"],i);
    }



    var popup = document.getElementById("popup-profile_move");
    if(popup.style.visibility === "hidden") {
        document.getElementById("page_blocker").style.zIndex = 6000;
        document.getElementById("page_blocker").style.display = "inline";
        document.getElementById("blur_section").setAttribute("style","filter: blur(2px);")
...
function hide_popup_profile_move() {
    document.getElementById("page_blocker").style.zIndex = 0;
    document.getElementById("page_blocker").style.display = "none";
    var popup = document.getElementById("popup-profile_move");
    document.getElementById("blur_section").setAttribute("style","filter: blur(0px);")
...
function add_profile() {
    var checkbox_add_same_shipping = document.getElementById("add-same_shipping");
    var checkbox_add_checkout_once = document.getElementById("add-checkout_once");
    var checkbox_add_same_names = document.getElementById("add-same_names");


    var profile_name = document.getElementById("add-profile-name").value;

    var bill_name = document.getElementById("add-billing-name").value;
    var bill_email = document.getElementById("add-billing-email").value;
    var bill_phone = document.getElementById("add-billing-phone").value;
    var bill_line1 = document.getElementById("add-billing-address1").value;
    var bill_line2 = document.getElementById("add-billing-address2").value;
    var bill_zip = document.getElementById("add-billing-zip").value;
    var bill_city = document.getElementById("add-billing-city").value;
    var bill_country = document.getElementById("add-billing-country").value;
    var bill_state = document.getElementById("add-billing-state").value;


    if (checkbox_add_same_shipping.checked == 1) {

        var same_shipping = true;

        var ship_name = bill_name;
        var ship_email = bill_email;
        var ship_phone = bill_phone;
        var ship_line1 = bill_line1;
        var ship_line2 = bill_line2;
        var ship_zip = bill_zip;
        var ship_city = bill_city;
        var ship_country = bill_country;
        var ship_state = bill_state;

        var card_type = document.getElementById("add-card_type").value;
        var card_number = document.getElementById("add-card_number").value;
        var card_exp_month = document.getElementById("add-card_exp_mo").value;
        var card_exp_year = document.getElementById("add-card_exp_yr").value;
        var card_cvv = document.getElementById("add-card_cvv").value;

        if(checkbox_add_same_names.checked == 1) {
            var same_names = true;
            var card_name = bill_name;
        } else {
            var same_names = false;
            var card_name = document.getElementById("add-card_name").value;
        }
    } else {

        var same_shipping = false;

        var ship_email = document.getElementById("add-shipping-email").value;
        var ship_phone = document.getElementById("add-shipping-phone").value;
        var ship_line1 = document.getElementById("add-shipping-address1").value;
        var ship_line2 = document.getElementById("add-shipping-address2").value;
        var ship_zip = document.getElementById("add-shipping-zip").value;
        var ship_city = document.getElementById("add-shipping-city").value;
        var ship_country = document.getElementById("add-shipping-country").value;
        var ship_state = document.getElementById("add-shipping-state").value;
        ...
        if(checkbox_add_same_names.checked == 1) {
            ...
            var ship_name = document.getElementById("add-shipping-name").value;
            var card_name = document.getElementById("add-card_name").value;
        }
    }

    if (checkbox_add_checkout_once.checked == 1) {
        var checkout_once = true;
    } else {
        var checkout_once = false;
    }

    // RESET ALL VALUES
    document.getElementById("add-profile-name").value = "";

    document.getElementById("add-billing-name").value = "";
    document.getElementById("add-billing-email").value = "";
    document.getElementById("add-billing-phone").value = "";
    document.getElementById("add-billing-address1").value = "";
    document.getElementById("add-billing-address2").value = "";
    document.getElementById("add-billing-zip").value = "";
    document.getElementById("add-billing-city").value = "";
    document.getElementById("add-billing-country").value = "-1";
    document.getElementById("add-billing-state").value = "";

    document.getElementById("add-shipping-email").value = "";
    document.getElementById("add-shipping-phone").value = "";
    document.getElementById("add-shipping-address1").value = "";
    document.getElementById("add-shipping-address2").value = "";
    document.getElementById("add-shipping-zip").value = "";
    document.getElementById("add-shipping-city").value = "";
    document.getElementById("add-shipping-country").value = "-1";
    document.getElementById("add-shipping-state").value = "";

    document.getElementById("add-card_type").value = "";
    document.getElementById("add-card_number").value = "";
    document.getElementById("add-card_exp_mo").value = "";
    document.getElementById("add-card_exp_yr").value = "";
    document.getElementById("add-card_cvv").value = "";

    checkbox_add_same_shipping.checked = false;
    checkbox_add_checkout_once.checked = false;
    checkbox_add_same_names.checked = false;
    ...
    var profile = {
        ...
        "profile_errors": [],
        "options": {
            "same_billing_shipping": same_shipping,
            "same_names": same_names,
            "checkout_once": checkout_once
        },
        "billing": {
            "name": bill_name,
      		"email": bill_email,
    ...
    xhr_profiles.open("POST","http://localhost:8081/profiles/add?group=" + profile_group_index)
    xhr_profiles.send(JSON.stringify(profile))

    hide_popup_profile_add()

    xhr_profiles.onload=function(){
        profiles = JSON.parse(xhr_profiles.responseText)
        update_profiles_table()
    }
}

function remove_profiles_confirm() {
    var remove_values = get_checked_in_profiles_table()
    xhr_profiles.open("POST","http://localhost:8081/profiles/remove?group=" + profile_group_index)
    xhr_profiles.send(JSON.stringify(remove_values))

    hide_popup_profile_remove()
...
function import_profiles_confirm() {
    var type = document.getElementById("profile_import-select").value

    xhr_profiles.open("POST","http://localhost:8081/profiles/import?group=" + profile_group_index + "&type=" + type)
    xhr_profiles.send()

    hide_popup_profile_import()

    xhr_profiles.onload=function() {
        var response = JSON.parse(xhr_profiles.responseText)
        if (response[0] == "error") {
            show_popup_profile_import_error()
        } else if (response[0] == "no action") {
            return
        } 
        else {
            profiles = JSON.parse(xhr_profiles.responseText)
...
function export_profiles_confirm() {
    var export_values = get_checked_in_export()
    
    hide_popup_profile_export()

    console.log(export_values)

    xhr_profiles.open("POST","http://localhost:8081/profiles/export?group=" + profile_group_index)
    xhr_profiles.send(JSON.stringify(export_values))
    xhr_profiles.onload=function() { 
        var response = xhr_profiles.responseText
        if(response[0] == "error") {
            show_popup_profile_export_error()
        }
        else {
            show_popup_profile_export_success()
        }
    }

}
function jig_profiles_confirm() {
    var jig_values = get_checked_in_profiles_table()
    
    var jig_amount = document.getElementById("profile_jig-select").value
    var jig_line1 = document.getElementById("profile_jig-line1").value
    var jig_line2 = document.getElementById("profile_jig-line2").value
    var jig_line1_param = document.getElementById("profile_jig-line1-param").value
    var jig_line2_param = document.getElementById("profile_jig-line2-param").value
    var jig_catchall = ""

    if(document.getElementById("jig-first_name").checked) {
        var jig_first = 0
    } else {
        var jig_first = 1
    }
    if(document.getElementById("jig-last_name").checked) {
        var jig_last = 0
    } else {
        var jig_last = 1
    }
    if(document.getElementById("jig-card_name").checked) {
        var jig_card = 0
    } else {
        var jig_card = 1
    }

    if(document.getElementById("jig-email").checked) {
        var jig_email = 0
    } else {
        var jig_email = 1
    }
    if(document.getElementById("jig-phone").checked) {
        var jig_phone = 0
    } else {
        var jig_phone = 1
    }

    if(document.getElementById("jig-billing").checked) {
        var jig_billing = 0
    } else {
        var jig_billing = 1
    }
    if(document.getElementById("jig-shipping").checked) {
        var jig_shipping = 0
    } else {
        var jig_shipping = 1
    }
    if(document.getElementById("jig-apt").checked) {
        var jig_apt = 0
    } else {
        var jig_apt = 1
    }
    if(document.getElementById("jig-email-catchall").checked) {
        jig_catchall = document.getElementById("profile_jig-catchall-input").value
    }
    if(document.getElementById("jig-email-dottrick").checked) {
        console.log("dot trick checked")
        var dot_trick = 0
    } else {
        console.log("dot trick unchecked")
        var dot_trick = 1
    }

    
    xhr_profiles.open("POST","http://localhost:8081/profiles/jig?group=" + profile_group_index + "&amount=" + jig_amount + "&first=" + jig_first + "&last=" + jig_last + "&email=" + jig_email + "&phone=" + jig_phone + "&billing=" + jig_billing + "&shipping=" + jig_shipping + "&line1=" + jig_line1 + "&line2=" + jig_line2 + "&apt=" + jig_apt + "&catch=" + jig_catchall + "&dot_trick=" + dot_trick + "&line1_param=" + jig_line1_param + "&line2_param=" + jig_line2_param + "&card=" + jig_card)
    xhr_profiles.send(JSON.stringify(jig_values))

    hide_popup_profile_jig()

    xhr_profiles.onload=function() {
        profiles = JSON.parse(xhr_profiles.responseText)
        update_profiles_groups()
    }
}
function move_profiles_confirm() {
    var move_values = get_checked_in_profiles_table()
    var group_value = document.getElementById("profile_move-select").value

    hide_popup_profile_move()

    xhr_profiles.open("POST","http://localhost:8081/profiles/move?group=" + profile_group_index + "&new_group=" + group_value)
    xhr_profiles.send(JSON.stringify(move_values))
...
function quick_edit_profile(i) {
    profile_index = i;
    document.getElementById("quick_edit-name").value = profiles["groups"][profile_group_index]["profiles"][i]["billing"]["name"]
    document.getElementById("quick_edit-email").value = profiles["groups"][profile_group_index]["profiles"][i]["billing"]["email"]
    document.getElementById("quick_edit-phone").value = profiles["groups"][profile_group_index]["profiles"][i]["billing"]["phone"]
    document.getElementById("quick_edit-address").value = profiles["groups"][profile_group_index]["profiles"][i]["billing"]["line1"]
    document.getElementById("quick_edit-address2").value = profiles["groups"][profile_group_index]["profiles"][i]["billing"]["line2"]
    document.getElementById("quick_edit-zip").value = profiles["groups"][profile_group_index]["profiles"][i]["billing"]["post_code"]
    document.getElementById("quick_edit-city").value = profiles["groups"][profile_group_index]["profiles"][i]["billing"]["city"]

    document.getElementById("quick_edit-country").value = profiles["groups"][profile_group_index]["profiles"][i]["billing"]["country"]

    add_states("quick_edit-country","quick_edit-state")

    document.getElementById("quick_edit-state").value = profiles["groups"][profile_group_index]["profiles"][i]["billing"]["state"]

    document.getElementById("quick_edit-card_type").value = profiles["groups"][profile_group_index]["profiles"][i]["card"]["type"]
    document.getElementById("quick_edit-card_name").value = profiles["groups"][profile_group_index]["profiles"][i]["card"]["name"]
    document.getElementById("quick_edit-card_number").value = profiles["groups"][profile_group_index]["profiles"][i]["card"]["no"]
    document.getElementById("quick_edit-card_exp_mo").value = profiles["groups"][profile_group_index]["profiles"][i]["card"]["mo"]
    document.getElementById("quick_edit-card_exp_yr").value = profiles["groups"][profile_group_index]["profiles"][i]["card"]["yr"]
    document.getElementById("quick_edit-card_cvv").value = profiles["groups"][profile_group_index]["profiles"][i]["card"]["cvv"]

    if(profiles["groups"][profile_group_index]["profiles"][i]["options"]["same_billing_shipping"]) {
        document.getElementById("quick_edit-same_shipping").checked = true;
    } else {
        document.getElementById("quick_edit-same_shipping").checked = false;
    }

    if(profiles["groups"][profile_group_index]["profiles"][i]["options"]["checkout_once"]) {
        document.getElementById("quick_edit-checkout_once").checked = true;
    } else {
        document.getElementById("quick_edit-checkout_once").checked = false;
    }

}
function quick_edit_profile_save() {
    
    var profile = profiles["groups"][profile_group_index]["profiles"][profile_index]

    

    var bill_name = document.getElementById("quick_edit-name").value;
    var bill_email = document.getElementById("quick_edit-email").value;
    var bill_phone = document.getElementById("quick_edit-phone").value;
    var bill_line = document.getElementById("quick_edit-address").value;
    var bill_line2 = document.getElementById("quick_edit-address2").value;
    var bill_zip = document.getElementById("quick_edit-zip").value;
    var bill_city = document.getElementById("quick_edit-city").value;
    var bill_country = document.getElementById("quick_edit-country").value;
    var bill_state = document.getElementById("quick_edit-state").value;

    var card_name = document.getElementById("quick_edit-card_name").value;
    var card_type = document.getElementById("quick_edit-card_type").value;
    var card_number = document.getElementById("quick_edit-card_number").value;
    var card_exp_month = document.getElementById("quick_edit-card_exp_mo").value;
    var card_exp_year = document.getElementById("quick_edit-card_exp_yr").value;
    var card_cvv = document.getElementById("quick_edit-card_cvv").value;

    var same_shipping = document.getElementById("quick_edit-same_shipping").checked
    var checkout_once = document.getElementById("quick_edit-checkout_once").checked

    profile["billing"]["name"] = bill_name
    profile["billing"]["email"] = bill_email
    profile["billing"]["phone"] = bill_phone
    profile["billing"]["line1"] = bill_line
    profile["billing"]["line2"] = bill_line
    profile["billing"]["city"] = bill_city
    profile["billing"]["post_code"] = bill_zip
    profile["billing"]["state"] = bill_state
    profile["billing"]["country"] = bill_country

    profile["card"]["name"] = card_name
    profile["card"]["type"] = card_type
    profile["card"]["no"] = card_number
    profile["card"]["mo"] = card_exp_month
    profile["card"]["yr"] = card_exp_year
    profile["card"]["cvv"] = card_cvv

    profile["options"]["same_billing_shipping"] = same_shipping
    profile["options"]["checkout_once"] = checkout_once

    if(same_shipping) {
        profile["shipping"]["name"] = bill_name
        profile["shipping"]["email"] = bill_email
        profile["shipping"]["phone"] = bill_phone
        profile["shipping"]["line1"] = bill_line
        profile["shipping"]["line1"] = bill_line2
        profile["shipping"]["city"] = bill_city
        profile["shipping"]["post_code"] = bill_zip
        profile["shipping"]["state"] = bill_state
        profile["shipping"]["country"] = bill_country
    }

    xhr_profiles.open("POST","http://localhost:8081/profiles/edit?group=" + profile_group_index + "&profile=" + profile_index)
    xhr_profiles.send(JSON.stringify(profile))
...
function edit_profile_save() {
    ...
    profile["profile_name"] = document.getElementById("edit-profile-name").value

    profile["billing"]["name"] = document.getElementById("edit-billing-name").value
    profile["billing"]["email"] = document.getElementById("edit-billing-email").value
    profile["billing"]["phone"] = document.getElementById("edit-billing-phone").value
    profile["billing"]["line1"] = document.getElementById("edit-billing-address1").value
    profile["billing"]["line2"] = document.getElementById("edit-billing-address2").value
    profile["billing"]["post_code"] = document.getElementById("edit-billing-zip").value
    profile["billing"]["city"] = document.getElementById("edit-billing-city").value
    profile["billing"]["country"] = document.getElementById("edit-billing-country").value
    profile["billing"]["state"] = document.getElementById("edit-billing-state").value

    profile["card"]["type"] = document.getElementById("edit-card_type").value
    
    profile["card"]["no"] = document.getElementById("edit-card_number").value
    profile["card"]["mo"] = document.getElementById("edit-card_exp_mo").value
    profile["card"]["yr"] = document.getElementById("edit-card_exp_yr").value
    profile["card"]["cvv"] = document.getElementById("edit-card_cvv").value

    var same_shipping = document.getElementById("edit-same_shipping").checked
    var checkout_once = document.getElementById("edit-checkout_once").checked
    var same_names = document.getElementById("edit-same_names").checked

    profile["options"]["same_billing_shipping"] = same_shipping
    profile["options"]["checkout_once"] = checkout_once
    profile["options"]["same_names"] = same_names

    if (same_shipping) {
        profile["shipping"]["name"] = document.getElementById("edit-billing-name").value
        profile["shipping"]["email"] = document.getElementById("edit-billing-email").value
        profile["shipping"]["phone"] = document.getElementById("edit-billing-phone").value
        profile["shipping"]["line1"] = document.getElementById("edit-billing-address1").value
        profile["shipping"]["line2"] = document.getElementById("edit-billing-address2").value
        profile["shipping"]["post_code"] = document.getElementById("edit-billing-zip").value
        profile["shipping"]["city"] = document.getElementById("edit-billing-city").value
        profile["shipping"]["country"] = document.getElementById("edit-billing-country").value
        profile["shipping"]["state"] = document.getElementById("edit-billing-state").value

        if(same_names) {
            profile["card"]["name"] = document.getElementById("edit-billing-name").value
        } else {
            profile["card"]["name"] = document.getElementById("edit-card_name").value
        }
    } else {
        profile["shipping"]["email"] = document.getElementById("edit-shipping-email").value
        profile["shipping"]["phone"] = document.getElementById("edit-shipping-phone").value
        profile["shipping"]["line1"] = document.getElementById("edit-shipping-address1").value
        profile["shipping"]["line2"] = document.getElementById("edit-shipping-address2").value
        profile["shipping"]["post_code"] = document.getElementById("edit-shipping-zip").value
        profile["shipping"]["city"] = document.getElementById("edit-shipping-city").value
        profile["shipping"]["country"] = document.getElementById("edit-shipping-country").value
        profile["shipping"]["state"] = document.getElementById("edit-shipping-state").value

        if(same_names) {
            profile["shipping"]["name"] = document.getElementById("edit-billing-name").value
            profile["card"]["name"] = document.getElementById("edit-billing-name").value
        } else {
            profile["shipping"]["name"] = document.getElementById("edit-shipping-name").value
            profile["card"]["name"] = document.getElementById("edit-card_name").value
        }
    }
...
function check_all_in_profiles_table() {
    var checkbox_check_all = document.getElementById("profiles-header_checkbox");
    var table = document.getElementById("profiles-main_table");
...
function get_checked_in_profiles_table() {
    var checked_values = []
    var table = document.getElementById("profiles-main_table");
    for(let i = 0; i < table.rows.length; i++) {
        if(table.rows[i].cells[4].getElementsByTagName('input')[0].checked) {
...
function get_checked_in_export() {
    var checked_values = []
    var table = document.getElementById("export_option-table_main")
    for(let i = 0; i < table.rows.length; i++) {
        if(table.rows[i].cells[0].getElementsByTagName('input')[0].checked) {
            var format_name = table.rows[i].cells[1].innerHTML;
            var format_alias = "";
            if(format_name == "Splash Tools") {
                format_alias = "splash"
            }
            else if(format_name == "AYCD") {
                format_alias = "aycd"
            }
            else if(format_name == "Balko Bot") {
                format_alias = "balko"
            }
            else if(format_name == "Better Nike Bot") {
                format_alias = "bnb"
            }
            else if(format_name == "CandyPreme") {
                format_alias = "candypreme"
            }
            else if(format_name == "Cyber") {
                format_alias = "cyber"
            }
            else if(format_name == "Dashe") {
                format_alias = "dashe"
            }
            else if(format_name == "Eve Aio") {
                format_alias = "eve"
            }
            else if(format_name == "Ganesh CLI") {
                format_alias = "ganesh_cli"
            }
            else if(format_name == "Ganesh GUI") {
                format_alias = "ganesh_gui"
            }
            else if(format_name == "Ghost") {
                format_alias = "ghost"
            }
            else if(format_name == "Kodai") {
                format_alias = "kodai"
            }
            else if(format_name == "KSR") {
                format_alias = "ksr"
            }
            else if(format_name == "MEKPreme") {
                format_alias = "mekpreme"
            }
            else if(format_name == "Nike Shoe Bot") {
                format_alias = "nsb"
            }
            else if(format_name == "Phantom") {
                format_alias = "phantom"
            }
            else if(format_name == "Polaris") {
                format_alias = "polaris"
            }
            else if(format_name == "Prism") {
                format_alias = "prism"
            }
            else if(format_name == "Project Destroyer") {
                format_alias = "pd"
            }
            else if(format_name == "Sole Aio") {
                format_alias = "sole"
            }
            else if(format_name == "TheKickStation") {
                format_alias = "tks"
            }
            else if(format_name == "Tohru") {
                format_alias = "tohru"
            }
            else if(format_name == "The Shit Bot") {
                format_alias = "tsb"
            }
            else if(format_name == "Velox") {
                format_alias = "velox"
            }
            else if(format_name == "Wrath") {
                format_alias = "wrath"
            }

            checked_values.push(format_alias)
        }
    }
    return checked_values
}
function toggle_name_jig() {
    if(document.getElementById("jig-first_name").checked || document.getElementById("jig-last_name").checked) {
        document.getElementById("profile_jig_card").style.display = "inline";
    } else {
        document.getElementById("profile_jig_card").style.display = "none";
    }
}
function toggle_address_jig() {
    if(document.getElementById("jig-billing").checked || document.getElementById("jig-shipping").checked) {
        document.getElementById("profile_jig-line1").style.display = "inline";
        document.getElementById("profile_jig-line2").style.display = "inline";
        document.getElementById("profile_jig-line1-param").style.display = "inline";
        document.getElementById("profile_jig-line2-param").style.display = "inline";
        document.getElementById("profile_jig-apt").style.display = "block";
        document.getElementById("profile_jig-line1_text1").style.display = "inline";
        document.getElementById("profile_jig-line2_text1").style.display = "inline";
        document.getElementById("profile_jig-line1_text2").style.display = "inline";
        document.getElementById("profile_jig-line2_text2").style.display = "inline";
        
    } else {
        document.getElementById("profile_jig-line1").style.display = "none";
        document.getElementById("profile_jig-line2").style.display = "none";
        document.getElementById("profile_jig-line1-param").style.display = "none";
        document.getElementById("profile_jig-line2-param").style.display = "none";
        document.getElementById("profile_jig-apt").style.display = "none";
        document.getElementById("profile_jig-line1_text1").style.display = "none";
        document.getElementById("profile_jig-line2_text1").style.display = "none";
        document.getElementById("profile_jig-line1_text2").style.display = "none";
        document.getElementById("profile_jig-line2_text2").style.display = "none";
    }
}
function toggle_email_jig() {
    if(document.getElementById("jig-email").checked) {
        document.getElementById("profile_jig-catchall-check").style.display = "inline";
        document.getElementById("profile_jig-catchall-input").style.display = "inline";
        document.getElementById("profile_jig-dottrick-check").style.display = "block";
    } else {
        document.getElementById("profile_jig-catchall-check").style.display = "none";
        document.getElementById("profile_jig-catchall-input").style.display = "none";
        document.getElementById("profile_jig-dottrick-check").style.display = "none";
    }
}

function update_profiles_table_empty() {
    var table = document.getElementById("profiles-main_table");
...
function update_profiles_table() {
    var table = document.getElementById("profiles-main_table");
    var profile_count = 0;
    document.getElementById("profiles-header_checkbox").checked = false;

    while(table.hasChildNodes())
    {
        table.removeChild(table.firstChild);
    }
    for(var i in profiles["groups"][profile_group_index]["profiles"]) {
        var row = table.insertRow(table.rows.length);

        var quick_edit_profile_command = "quick_edit_profile(" + i + ")"
        row.setAttribute("onclick",quick_edit_profile_command)


        var num = row.insertCell(0);
        var profile = row.insertCell(1);
        var name = row.insertCell(2);
        var address = row.insertCell(3);
        var checkbox_cell = row.insertCell(4);

        num.innerHTML = i;
        profile.innerHTML = profiles["groups"][profile_group_index]["profiles"][i]["profile_name"]
        name.innerHTML = profiles["groups"][profile_group_index]["profiles"][i]["billing"]["name"]
        address.innerHTML = profiles["groups"][profile_group_index]["profiles"][i]["billing"]["line1"]
    ...
    document.getElementById("profile_viewer-profiles-text").innerHTML = profile_count;
}
function update_profiles_table_by_search(search_term) {
    ...
    for(var i in profiles["groups"][profile_group_index]["profiles"]) {
        if(JSON.stringify(profiles["groups"][profile_group_index]["profiles"][i]).toLowerCase().indexOf(search_term) > -1){  
            var row = table.insertRow(table.rows.length);
...
// GROUPS 
function show_popup_profiles_group_remove() {
    var popup = document.getElementById("popup-profiles_group_remove");
    if(popup.style.visibility === "hidden") {
        document.getElementById("page_blocker").style.zIndex = 6000;
        document.getElementById("page_blocker").style.display = "inline";
        document.getElementById("blur_section").setAttribute("style","filter: blur(2px);")
...
function hide_popup_profiles_group_remove() {
    document.getElementById("page_blocker").style.zIndex = 0;
    document.getElementById("page_blocker").style.display = "none";
    var popup = document.getElementById("popup-profiles_group_remove");
    document.getElementById("blur_section").setAttribute("style","filter: blur(0px);")
...
function show_popup_profiles_group_name() {
    var popup = document.getElementById("popup-profiles_group_name");
    if(popup.style.visibility === "hidden") {
        document.getElementById("page_blocker").style.zIndex = 6000;
        document.getElementById("page_blocker").style.display = "inline";
        document.getElementById("blur_section").setAttribute("style","filter: blur(2px);")
...
function hide_popup_profiles_group_name() {
    document.getElementById("page_blocker").style.zIndex = 0;
    document.getElementById("page_blocker").style.display = "none";
    var popup = document.getElementById("popup-profiles_group_name");
    document.getElementById("blur_section").setAttribute("style","filter: blur(0px);")
...
function show_popup_profiles_group_edit() {
    var popup = document.getElementById("popup-profiles_group_edit");
    if(popup.style.visibility === "hidden") {
        document.getElementById("page_blocker").style.zIndex = 6000;
        document.getElementById("page_blocker").style.display = "inline";
        document.getElementById("blur_section").setAttribute("style","filter: blur(2px);")
...
function hide_popup_profiles_group_edit() {
    document.getElementById("page_blocker").style.zIndex = 0;
    document.getElementById("page_blocker").style.display = "none";
    var popup = document.getElementById("popup-profiles_group_edit");
    document.getElementById("blur_section").setAttribute("style","filter: blur(0px);")
...
function get_profiles_groups() {
	xhr_profiles.open("GET","http://localhost:8081/profiles/groups",true);
    xhr_profiles.send();
...
function update_profiles_groups() {
    var group_container = document.getElementById("profile_groups");
    ...
    for(var i in profiles["groups"]) {
        ...
        var remove_func = "remove_profiles_group(" + i.toString() + ")"
        var switch_func = "switch_profiles_group(" + i.toString() + ")"
        ...
        group_name.innerHTML = profiles["groups"][i]["name"];
    ...
    if (profiles["groups"].length != 6){
        ...
        group_add.setAttribute("id","add_profiles_group");
        group_add.setAttribute("class","group_add");
        group_add.setAttribute("onclick","show_popup_profiles_group_name()");

        group_container.appendChild(group_add);
    }
    

    switch_profiles_group(profile_group_index);
};
function switch_profiles_group(i) {
    var group_container = document.getElementById("profile_groups");
    var groups = group_container.childNodes;
    if(groups.length == 1) {
        profile_group_index = null;
        return;
    }
    ...
    profile_group_index = i
    update_profiles_table()
};
function add_profiles_group() {

    console.log("clicked")

    var inputValue = document.getElementById("popup-profile_group_name-input").value;
    document.getElementById("popup-profile_group_name-input").value = "";
    var requestValue = "http://localhost:8081/profiles/groups?task=add&name=" + inputValue;
    var popup = document.getElementById("popup-group_name");

	xhr_profiles.open("POST",requestValue);
    xhr_profiles.send();
    
    hide_popup_profiles_group_name()
...
function remove_profiles_group(i) {
    show_popup_profiles_group_remove()
    profile_group_remove_temp = i;
};
function remove_profiles_group_confirm() {
    var requestValue = "http://localhost:8081/profiles/groups?task=remove&index=" + profile_group_remove_temp;

    
	xhr_profiles.open("POST",requestValue);
    xhr_profiles.send();

    hide_popup_profiles_group_remove()
    xhr_profiles.onload=function(){
        profiles = JSON.parse(xhr_profiles.responseText);
        console.log(profiles)
...
function edit_profiles_group() {

    var i = profile_group_index

    document.getElementById("popup-profiles_group_edit-input").value = profiles["groups"][i]["name"]
    show_popup_profiles_group_edit()
    profile_group_edit_temp = i;
};
function edit_profiles_group_confirm() {
    var requestValue = "http://localhost:8081/profiles/groups?task=edit&index=" + profile_group_edit_temp + "&name=" + document.getElementById("popup-profiles_group_edit-input").value;

    
	xhr_profiles.open("POST",requestValue);
    xhr_profiles.send();

    hide_popup_profiles_group_edit()
    xhr_profiles.onload=function(){
        profiles = JSON.parse(xhr_profiles.responseText);
        console.log(profiles)
        update_profiles_groups();
...
function add_states( countryElementId, stateElementId ) {
    // Countries
